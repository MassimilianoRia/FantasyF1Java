-- ATTENZIONE: questo script elimina e ricrea integralmente fantasy_f1.
-- Eseguirlo solo su un database locale usa-e-getta dopo aver verificato il target.
-- Richiede MySQL 8.0.16 o successivo per l'applicazione effettiva dei CHECK.
